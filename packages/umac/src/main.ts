import { cli as app }         from '@umac/app'
import { cli as appearance }  from '@umac/appearance'
import { cli as cache }       from '@umac/cache'
import { cli as desktop }     from '@umac/desktop'
import { cli as finder }      from '@umac/finder'
import { cli as interacting } from '@umac/interacting'
import { cli as open }        from '@umac/open'
import { cli as run }         from '@umac/run'
import { cli as spotlight }   from '@umac/spotlight'
import { cli as sys }         from '@umac/system'
import { cli as terminal }    from '@umac/terminal'
import { UmacCommand }        from '@umac/utils'
import { cli as workflow }    from '@umac/workflow'
